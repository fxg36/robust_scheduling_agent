...
NO_OBSERVATION_FEATURES = 15  # describes the environment state each step
...
class RobustFlowshopGymEnv(gym.Env):
    ...
    def _set_initial_state(self):
        ...
        p1_jobs = 0
        for j in self.curr_candidate.job_dict.values():
            if j[5] == 'p1':
                p1_jobs += 1
    ...
    def _update_state(self, last=False, stats=None, final_result=None):
        ...
        if not last:
            ...
            self.state_dict["total_slack_ratio"] = self.mc["total_slack_mean_job"][job_task] / self.mc["mean_total_slack"]
            self.state_dict["free_slack_ratio"] = self.mc["free_slack_mean_job"][job_task] / self.mc["mean_free_slack"]
            ...
            #self.state_dict["step_rel"] = step_rel
    ...
    def step(self, action):
        ...
        no_slack = self.mc["total_slack_mean_job"][job_task] == 0
        slack_to_append = 0
