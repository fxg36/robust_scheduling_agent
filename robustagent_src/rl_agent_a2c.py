...
LEARNING_RATE_START = 0.003  # controls how much to change the model in response to the estimated error each time the model weights are updated
DISCOUNT_FACTOR = 0.98  # how much the reinforcement learning agents cares about rewards in the distant future
