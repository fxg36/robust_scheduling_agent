...
SAMPLES = 10 # no of samples for training/testing (see pickle file in project dir)
NO_JOBS = 4 # no jobs for training/testing (see pickle file in project dir)
NO_MONTE_CARLO_EXPERIMENTS = 888 # no. of monte carlo simulations to evaluate the schedule regarding to its robustness and stability (888)
